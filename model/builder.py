...
#         self.fc1 = Diagonal(self.in_size, self.maps[0].shape[0], use_bias, trainable_mask)  # sparse layer 27687*9229
#         # sparse layer 9227*1387
#         self.fc2 = CustomizedLinear(self.maps[0].shape[0], self.maps[0].shape[1], use_bias,
#                                     np.array(self.maps[0].values), trainable_mask)
#         # sparse layer 1387*1066
#         self.fc3 = CustomizedLinear(self.maps[1].shape[0], self.maps[1].shape[1], use_bias,
#                                     np.array(self.maps[1].values), trainable_mask)
#         # sparse layer 1066*447
#         self.fc4 = CustomizedLinear(self.maps[2].shape[0], self.maps[2].shape[1], use_bias,
#                                     np.array(self.maps[2].values), trainable_mask)
#         # sparse layer 447*147
#         self.fc5 = CustomizedLinear(self.maps[3].shape[0], self.maps[3].shape[1], use_bias,
#                                     np.array(self.maps[3].values), trainable_mask)
#         # sparse layer 147*26
#         self.fc6 = CustomizedLinear(self.maps[4].shape[0], self.maps[4].shape[1], use_bias,
#                                     np.array(self.maps[4].values), trainable_mask)
#         # self.fc1 = nn.Linear(self.in_size, self.maps[0].shape[0])  # sparse layer 27687*9229
#         # self.fc2 = nn.Linear(self.maps[0].shape[0], self.maps[0].shape[1])  # sparse layer 9227*1387
#         # self.fc3 = nn.Linear(self.maps[1].shape[0], self.maps[1].shape[1])  # sparse layer 1387*1066
#         # self.fc4 = nn.Linear(self.maps[2].shape[0], self.maps[2].shape[1])  # sparse layer 1066*447
#         # self.fc5 = nn.Linear(self.maps[3].shape[0], self.maps[3].shape[1])  # sparse layer 447*147
#         # self.fc6 = nn.Linear(self.maps[4].shape[0], self.maps[4].shape[1])  # sparse layer 147*26
#
...
#         out = self.Tanh(self.fc1(input))
#         o1 = self.sigmoid(self.l1(out))
#         out = self.dropout1(out)
#
#         out = self.Tanh(self.fc2(out))
#         o2 = self.sigmoid(self.l2(out))
#         out = self.dropout2(out)
#
#         out = self.Tanh(self.fc3(out))
#         o3 = self.sigmoid(self.l3(out))
#         out = self.dropout2(out)
#
#         out = self.Tanh(self.fc4(out))
#         o4 = self.sigmoid(self.l4(out))
#         out = self.dropout2(out)
#
#         out = self.Tanh(self.fc5(out))
#         o5 = self.sigmoid(self.l5(out))
#         out = self.dropout2(out)
#
#         out = self.Tanh(self.fc6(out))
#         o6 = self.sigmoid(self.l6(out))
#         out = self.dropout2(out)
#
#         return torch.concat([o1, o2, o3, o4, o5, o6], dim=1)
#         # loss = 0.
#         # for i in range(6):
#         #     loss += eval(f'o{i + 1}') * loss_weights[i]
#         # return loss / sum(loss_weights)
#
