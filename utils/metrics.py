...
class Metrics:
    ...
    @staticmethod
    def evaluate_classification_binary(y_prob, y_true, saving_dir: str = None):
        ...
        Animator.get_confusion_matrix(cnf_matrix, saving_dir)
        Animator.get_metrics(best_effect, saving_dir)
        Animator.get_auc(y_prob, y_true, saving_dir)
        Animator.get_auprc(y_prob, y_true, saving_dir)
